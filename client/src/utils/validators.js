...
export const validationMessages = {
  name: "Invalid name.",
  city: "City must contain alphabetic characters only.",
  gmail: "Email must be a valid @gmail.com address.",
  password:
    "Password must be at least 6 characters and contain letters or numbers only.",
  vehicleText: "Brand and model can contain letters, numbers, spaces, dot and hyphen only.",
  safeText: "Text must be meaningful and within the allowed length.",
  alphabeticText: "Text must contain alphabetic characters.",
  keywords: "Keywords must start with a letter and can contain letters, numbers, spaces or hyphen.",
  dateRange: "Return date must be after a valid pickup date.",
};
