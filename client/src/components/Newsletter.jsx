...
const Newsletter = () => {
  ...
  const onSubmit = async (e) => {
    ...
    // NEW VALIDATION: must start with alphabet (A-Z or a-z)
    if (!/^[A-Za-z]/.test(normalizedEmail)) {
      ...
      >
        ...
        <button
          ...
          className="md:px-12 px-8 h-full text-white
                 ...
                 rounded-md rounded-l-none disabled:bg-blue-400 disabled:cursor-not-allowed"
        >
